...
import { SearchInWorkspaceClient, SearchInWorkspaceResult, SearchInWorkspaceResultCompare } from '../common/search-in-workspace-interface';
...
/* Mock client that accumulates the returned results in a alist.  */
...
describe('ripgrep-search-in-workspace-server', () => {
        ...
        it('returns 5 results when searching for "carrot"', function (done) {
