    ...
    async applyEdit(changes: lang.WorkspaceEdit): Promise<boolean> {
        ...
        for (const uri of uri2Edits.keys()) {
            ...
            if (editor) {
                ...
                const currentSelection = new monaco.Selection(
                ...
                model.pushEditOperations([currentSelection], editOperations, (undoEdits: monaco.editor.IIdentifiedSingleEditOperation[]) => [currentSelection]);
