...
import { SidePanelHandler, SidePanelLayoutData, MAIN_BOTTOM_AREA_CLASS, SidePanelHandlerFactory } from './side-panel-handler';
...
export class ApplicationShell extends Widget {
    ...
    protected registerWithFocusTracker(data: DockLayout.ITabAreaConfig | DockLayout.ISplitAreaConfig | SidePanelLayoutData | null): void {
        if (data) {
    ...
    addWidget(widget: Widget, options: ApplicationShell.WidgetOptions) {
        if (!widget.id) {
            console.error('Widgets added to the application shell must have unique id property.');
            return;
        }
        switch (options.area) {
            case 'main':
            ...
            case 'top':
                ...
                break;
            case 'left':
                this.leftPanelHandler.addWidget(widget, options.rank);
                break;
            case 'right':
                this.rightPanelHandler.addWidget(widget, options.rank);
                break;
            case 'bottom':
                this.bottomPanelHandler.addWidget(widget, options.rank);
                break;
            default:
...
export namespace ApplicationShell {
    ...
    export interface LayoutData {
        ...
        leftPanel?: SidePanelLayoutData;
        rightPanel?: SidePanelLayoutData;
        bottomPanel?: SidePanelLayoutData;
